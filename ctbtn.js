window.ctfile = {
    ...
    makeBtn: (fileid, password) => {
        ...
        btn.style = "display: flex;flex-direction: row;margin: 4px;height: 32px;border: 1px solid #666;border-radius: 4px;background-color: #ffffff;cursor: wait;transition: background-color 0.5s;"
